# KUET-MINDS Official Documentation Repository
...
- **Major.Minor.Patch.Build** (e.g., v1.0.0.0)
- **Major (1)**: Complete curriculum overhauls or new specialization tracks
- **Minor (0)**: New courses, significant content additions, or structural changes
...
**Duration**: 21+ days | **Projects**: 3 | **Levels**: 3

1. **Level 1**: Noob's Guide to ML - Fundamentals and first neural networks
2. **Level 2**: Core ML - Advanced algorithms and optimization techniques  
